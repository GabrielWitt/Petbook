...
let ProfileDetailComponent = class ProfileDetailComponent {
  constructor(modal, alert, users, pets) {
    this.modal = modal;
    this.alert = alert;
    this.users = users;
    this.pets = pets;
  ...
  upgradeUser() {
    this.alert.AlertConfirm('CAMBIO A ADMINISTRADOR', '¿Está seguro que desea cambiar a este usuario a Administrador?').then(answer => {
      if (answer) {
...
ProfileDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
