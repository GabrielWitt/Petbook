...
let ProfileManagerPage = class ProfileManagerPage {
  constructor(pets, router, alerts, modal, upload, images, routerOutlet, formBuilder, auth, verification) {
    this.pets = pets;
    this.router = router;
    this.alerts = alerts;
    this.modal = modal;
  ...
  doRefresh(refresh) {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Ingenieri_a_de_Software_Petbook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this2.checkUser().then(done => {
        console.log('done');
  ...
  newPet() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Ingenieri_a_de_Software_Petbook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const modal = yield _this3.modal.create({
        component: src_app_shared_components_pets_new_pet_new_pet_component__WEBPACK_IMPORTED_MODULE_7__.NewPetComponent,
        componentProps: {
          pet: null,
          userData: _this3.userData
        },
        mode: 'ios',
  ...
  newReport(pet) {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Ingenieri_a_de_Software_Petbook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (modalResult.data) {
        _this5.router.navigateByUrl('administrator/news');
      }
    })();
  }
...
ProfileManagerPage = (0,tslib__WEBPACK_IMPORTED_MODULE_14__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_15__.Component)({
...
module.exports = ".ripple-parent {\n  position: relative;\n  overflow: hidden;\n}\n\n.profileCircle {\n  --border-radius: 50%;\n  --size: 40pt;\n  position: relative;\n}\n\n.redImage {\n  border: 3pt solid var(--ion-color-danger);\n}\n\n.grayScale {\n  filter: grayscale(100%);\n}\n\n.cameraButton {\n  position: absolute;\n  background-color: var(--ion-color-medium);\n  top: 25pt;\n  left: 25pt;\n  width: 20pt;\n  height: 20pt;\n  font-size: 15pt;\n  border-radius: 50%;\n  padding: 2pt;\n}\n\n.uploadingImage {\n  position: absolute;\n  top: 10pt;\n  left: 10pt;\n}\n\n.imageProfile {\n  position: absolute;\n}\n\n.loadingImage {\n  position: absolute;\n  top: 41pt;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
