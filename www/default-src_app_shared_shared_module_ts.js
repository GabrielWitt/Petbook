...
let FireAuthService = class FireAuthService {
  ...
  readUserForm(uid) {
    return new Promise((resolve, reject) => {
      this.FS.readDocument('users', uid).then(doc => {
        resolve(doc);
      }).catch(error => {
        reject(this.error.handle(error));
      });
  ...
  uploadUserForm(uid, data) {
    return new Promise((resolve, reject) => {
      this.FS.setNamedDocument('users', uid, data).then(data => {
        resolve('done');
      }).catch(error => {
        reject(this.error.handle(error));
      });
...
let NewPetComponent = class NewPetComponent {
  ...
  loadSpecies() {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Ingenieri_a_de_Software_Petbook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        _this.speciesList = yield _this.pets.readSpecies();
        _this.colorList = yield _this.pets.readColors();
        return 'done';
      } catch (error) {
        console.log(error);
        return 'error';
  ...
  uploadPhoto() {
    return new Promise((resolve, reject) => {
      ...
      this.upload.uploadFile('PetList', imageName, this.newImage.file, progress => {
        this.progress = progress;
      }).then(data => {
        this.upload.deletePicture();
        resolve(data.url);
  ...
  handleCalendar(e) {
    ...
    if (this.showCalendar) {
      if (this.myPetData.birthDate !== fecha) {
        this.myPetData.birthDate = fecha;
      }
...
const pipes = [
    ...
    _pipes_time_format_pipe__WEBPACK_IMPORTED_MODULE_8__.TimeFormatPipe
];
...
(function (root, factory) {
  ...
  if ( true && module.exports) {
    module.exports = factory(__webpack_require__(/*! moment */ 56908)); // Node
  } else if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! moment */ 56908)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
"use strict";
module.exports = ".profileCircle {\n  --border-radius: 50%;\n  --size: 40pt ;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 27861:
/*!***************************************************************************************!*\
  !*** ./src/app/shared/components/user-profile/user-profile.component.html?ngResource ***!
  \***************************************************************************************/
/***/ ((module) => {
