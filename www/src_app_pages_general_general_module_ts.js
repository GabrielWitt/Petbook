...
/* harmony import */ var _forgot_password_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./forgot-password.component.html?ngResource */ 4357);
/* harmony import */ var _forgot_password_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./forgot-password.component.scss?ngResource */ 8164);
...
/* harmony import */ var src_app_shared_utilities_route_history__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/utilities/route-history */ 6147);
/* harmony import */ var src_app_shared_utilities_verificationFunc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/utilities/verificationFunc */ 4264);
...
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ 5219);
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login/login.component */ 3956);
/* harmony import */ var _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sign-up/sign-up.component */ 5090);
/* harmony import */ var _verify_email_verify_email_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./verify-email/verify-email.component */ 717);
...
/* harmony import */ var _general_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./general-routing.module */ 2892);
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login/login.component */ 3956);
/* harmony import */ var src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/shared.module */ 4466);
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ 5219);
/* harmony import */ var _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sign-up/sign-up.component */ 5090);
/* harmony import */ var _verify_email_verify_email_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./verify-email/verify-email.component */ 717);
...
/* harmony import */ var _login_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.component.html?ngResource */ 9928);
/* harmony import */ var _login_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.component.scss?ngResource */ 9115);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ 2508);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ 124);
/* harmony import */ var src_app_core_services_firebase_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/services/firebase.service */ 1683);
/* harmony import */ var src_app_shared_utilities_route_history__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/utilities/route-history */ 6147);
...
/* harmony import */ var _sign_up_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sign-up.component.html?ngResource */ 5934);
/* harmony import */ var _sign_up_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sign-up.component.scss?ngResource */ 6505);
...
/* harmony import */ var src_app_shared_utilities_alerts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/utilities/alerts */ 884);
/* harmony import */ var src_app_shared_utilities_route_history__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/utilities/route-history */ 6147);
/* harmony import */ var src_app_shared_utilities_validators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/utilities/validators */ 7916);
/* harmony import */ var src_app_shared_utilities_verificationFunc__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/utilities/verificationFunc */ 4264);
...
/* harmony import */ var _verify_email_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./verify-email.component.html?ngResource */ 3108);
/* harmony import */ var _verify_email_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./verify-email.component.scss?ngResource */ 6887);
...
/***/ 8123:
/*!**************************************************!*\
  !*** ./src/app/shared/utilities/time-handler.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TimeHandlerModule": () => (/* binding */ TimeHandlerModule),
/* harmony export */   "joinDateTimeInISO8601": () => (/* binding */ joinDateTimeInISO8601)
/* harmony export */ });
...
/* harmony import */ var moment_timezone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! moment-timezone */ 2469);
...
let TimeHandlerModule = class TimeHandlerModule {
  constructor() {
    this.year = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Deciembre'];

    this.joinDateTimeInISO8601 = (date, time) => {
      const momentTime = moment__WEBPACK_IMPORTED_MODULE_1__(time, 'HH:mm');
      return moment__WEBPACK_IMPORTED_MODULE_1__(date).set({
        h: momentTime.hours(),
        m: momentTime.minutes(),
        s: 0
  ...
  formatUTC(dateInfo) {
    return moment__WEBPACK_IMPORTED_MODULE_1__().utc(dateInfo).format();
  }

  getUTCHours(time) {
    const day = moment__WEBPACK_IMPORTED_MODULE_1__(time).format('DD-MM-YYYY');
    const hour = parseInt(moment__WEBPACK_IMPORTED_MODULE_1__(time).format('H'));
    const min = parseInt(moment__WEBPACK_IMPORTED_MODULE_1__(time).format('m'));
    return moment__WEBPACK_IMPORTED_MODULE_1__(day, 'DD-MM-YYYY').hours(hour).minutes(min).toDate();
  }

  getCurrentNYTime() {
    const day = moment_timezone__WEBPACK_IMPORTED_MODULE_2__().tz('America/Guayaquil').format('MM-DD-YYYY');
    const hour = parseInt(moment_timezone__WEBPACK_IMPORTED_MODULE_2__().tz('America/Guayaquil').format('H'));
    const min = parseInt(moment_timezone__WEBPACK_IMPORTED_MODULE_2__().tz('America/Guayaquil').format('m'));
    return moment__WEBPACK_IMPORTED_MODULE_1__(day, 'MM-DD-YYYY').hours(hour).minutes(min).toDate();
  }
  ...
  DateFixer(date, hours) {
    let now = '' + moment__WEBPACK_IMPORTED_MODULE_1__().format();

    if (date) {
      now = '' + moment__WEBPACK_IMPORTED_MODULE_1__(date).format();
    }

    const translator = moment__WEBPACK_IMPORTED_MODULE_1__.utc(hours).format('kk:mm:ss');
    return now.split('T')[0] + 'T' + translator;
  }

  ReservationDateString(start, end) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(start).format('dddd, MM/DD/YYYY | h:mm a') + ' - ' + moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(end).format('h:mm a');
  }
  ...
  maxTimeString(date) {
    ...
    if (date) {
      ...
      hours = hours.split('.')[0]; // tslint:disable-next-line: radix
  ...
  getTodayMidDay() {
    return moment__WEBPACK_IMPORTED_MODULE_1__().set({
      h: 12,
      m: 0,
      s: 0,
      ms: 0
  ...
  getTomorrow() {
    return moment__WEBPACK_IMPORTED_MODULE_1__().add(1, 'day').set({
      h: 12,
      m: 0,
      s: 0,
      ms: 0
  ...
  getMonth(date) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).format('MMMM YYYY');
  }
  ...
  getUTCDate(date) {
    const dateFix = {
      day: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).format('MM/DD/YY'),
      display: moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(date).format('ddd, MMM DD, hh:mm A')
    };
    return dateFix;
  }
  ...
  getDateOrder(a, b) {
    return moment__WEBPACK_IMPORTED_MODULE_1__(a).isAfter(moment__WEBPACK_IMPORTED_MODULE_1__(b)) ? -1 : moment__WEBPACK_IMPORTED_MODULE_1__(b).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__(a)) ? 1 : 0;
  }

  checkBundleDate(limitDate, startDate) {
    return moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(limitDate) > moment__WEBPACK_IMPORTED_MODULE_1__.parseZone(startDate);
  }
  ...
  fixByMonth(list) {
    ...
    return (0,_Users_gabrielwitt_Desktop_UTPL_Ingenieri_a_de_Software_Petbook_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      let final = [];
      let count = 1;
      const sortList = list.sort((a, b) => _this.getDateOrder(a, b)); // tslint:disable-next-line: prefer-const
      ...
      for (const billData of sortList) {
        ...
        if (billData.created_at) {
          ...
          created_at = billData.services[0].created_at;
        }
      ...
      for (const m of _this.year) {
        if (Months[count].length !== 0) {
          const Month = {
            name: Months[count][0].created_at,
            services: Months[count]
          };
          final.push(Month);
        }
      ...
      final = final.sort((a, b) => _this.getDateOrder(a.name, b.name));
      return final;
    })();
  }

};
TimeHandlerModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
  declarations: [],
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule]
})], TimeHandlerModule);

const joinDateTimeInISO8601 = (date, time) => {
  const momentTime = moment__WEBPACK_IMPORTED_MODULE_1__(time, 'HH:mm');
  return moment__WEBPACK_IMPORTED_MODULE_1__(date).set({
    h: momentTime.hours(),
    m: momentTime.minutes(),
...
"use strict";
module.exports = "ion-item {\n  --border-color: #000;\n  --backgroud: var(--ion-color-light-shade) ;\n}\n\n.forgot_text {\n  width: 100%;\n  text-align: end;\n  margin: 0;\n  padding-top: 15px;\n  font-size: 14px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".fullWidth {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
